...
#===================================================================================
        ...
        # msg = of.ofp_flow_mod(match=monitor.match.clone())
        # msg.match.dl_dst, msg.match.dl_src, msg.match.tp_dst, msg.match.tp_src= (None,) * 4
        # msg.match.nw_src = IPAddr('10.0.0.12')
        # msg.match.nw_dst = IPAddr('10.0.0.14')
        # msg.actions.append(of.ofp_action_output(port=adj[2][4]))
        # switches[2].connection.send(msg)

        # msg = of.ofp_flow_mod(match=monitor.match.clone())
        # msg.match.dl_dst, msg.match.dl_src, msg.match.tp_dst, msg.match.tp_src= (None,) * 4
        # msg.match.nw_src = IPAddr('10.0.0.12')
        # msg.match.nw_dst = IPAddr('10.0.0.14')
        # msg.actions.append(of.ofp_action_dl_addr.set_dst(dl_addr = EthAddr("00:00:00:00:00:14")))
        # msg.actions.append(of.ofp_action_output(port=3))
        # switches[4].connection.send(msg)

        # msg = of.ofp_flow_mod(match=monitor.match.clone())
        # msg.match.dl_dst, msg.match.dl_src, msg.match.tp_dst, msg.match.tp_src= (None,) * 4
        # msg.match.nw_src = IPAddr('10.0.0.14')
        # msg.match.nw_dst = IPAddr('10.0.0.12')
        # msg.actions.append(of.ofp_action_output(port=adj[4][2]))
        # switches[4].connection.send(msg)
        ...
        # msg.match.nw_src = IPAddr('10.0.0.14')
        # msg.match.nw_dst = IPAddr('10.0.0.12')
        # msg.actions.append(of.ofp_action_dl_addr.set_dst(dl_addr = EthAddr("00:00:00:00:00:12")))
...
#===================================================================================
        ...
        for node in adj_path.keys():
            for nextnode in adj_path[node].keys():
                ...
                if nextnode in node_list:
                    msg.actions.append(of.ofp_action_nw_addr.set_src(nw_addr = IPAddr('10.0.0.3')))
                    msg.actions.append(of.ofp_action_output(port=adj[nextnode][monitor.dpid]))
        ...
        #r24shou dao shi jian de switch yi hou
        for nextnode in node_list:
            msg = of.ofp_flow_mod()
            msg.match = monitor.match.clone()   
            ...
            msg.match.nw_dst = IPAddr('10.0.0.2')
            msg.match.in_port = adj[monitor.dpid][nextnode]

            #修改IP
            msg.actions.append(of.ofp_action_nw_addr.set_dst(nw_addr = monitor.ip))
            msg.actions.append(of.ofp_action_dl_addr.set_dst(dl_addr = monitor.hw))
            msg.actions.append(of.ofp_action_dl_addr.set_src(dl_addr = EthAddr("00:00:00:00:00:03")))
            msg.actions.append(of.ofp_action_output(port=monitor.switch_port))
            switches[monitor.dpid].connection.send(msg)
